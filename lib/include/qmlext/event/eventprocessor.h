...
{
public:
    using EventPublisher = std::function<void(const Event &event, const QVariant &id, const QVariant &value)>;
    ...
    virtual void execute(EventPublisher eventPublisher, const QVariant &id, const QVariant &args) = 0;
